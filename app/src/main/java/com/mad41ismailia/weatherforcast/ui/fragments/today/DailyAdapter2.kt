...
class DailyAdapter2(private val list:List<Daily>) : RecyclerView.Adapter<DailyAdapter2.ViewHolder>() {
...
//        holder.txtDayName.text = task.dt.toString()
        ...
        holder.imgDayIcon.setImageResource(setImg(task.weather[0].icon))
    }
