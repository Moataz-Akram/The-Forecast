package com.mad41ismailia.weatherforecast.repo
...
import com.mad41ismailia.weatherforecast.entity.DatabaseClasses.CityWeatherData
import com.mad41ismailia.weatherforecast.entity.comingData.WeatherData
import com.mad41ismailia.weatherforecast.repo.Room.WeatherDatabase
import com.mad41ismailia.weatherforecast.repo.retrofit.UseRetrofit
import com.mad41ismailia.weatherforecast.repo.sharedPreference.SharedPreference
...
class Repository private constructor(private val application: Application) {
    ...
    fun deleteOldCurrentCityData(currentCity: String) {
        CoroutineScope(Dispatchers.Default).launch {
            weatherDao.deleteWeatherCityData(currentCity)
        }
    }
}
